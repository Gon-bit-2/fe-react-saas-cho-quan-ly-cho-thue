      ...
      <div className="pl-sidebar-width min-h-screen flex flex-col">
        ...
        <header className="fixed top-0 left-sidebar-width right-0 h-topbar-height bg-surface/90 backdrop-blur-md border-b border-surface-border z-40 flex items-center justify-between px-page-padding-desktop">
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-outline-variant bg-surface-container-lowest text-on-surface hover:bg-surface-container transition-colors">
          ...
          <div className="flex items-center gap-6">
            <div className="relative flex items-center justify-center cursor-pointer hover:bg-surface-container p-2 rounded-full transition-colors">
