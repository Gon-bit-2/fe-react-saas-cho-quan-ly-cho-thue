...
export function useViewingAppointments(params: { page?: number; limit?: number; status?: AppointmentStatus; search?: string } = {}) {
...
export function useUpdateViewingAppointmentStatus(id: number) {
  ...
  return useMutation({
    mutationFn: async (body: { status: AppointmentStatus; scheduledAt?: string; assignedStaffId?: number | null; landlordNote?: string | null }) => {
